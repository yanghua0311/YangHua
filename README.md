...
该项目为国内最大通用积分平台的核心交易系统，系统目前存在7亿账户，每天日均2000万条交易；该项目我主要负责系统架构升级包括jdk升级、maven改造、接入配置中心、调度中心、限流框架，负责设计系统多层账户间、交易与流水间的对账体系，参与项目分库分表、oracle替换为mysql等重大系统变更设计；日常保证系统的高性能高可用，及时响应监控排查问题。
